...
const OFF_TOPIC_REDIRECT_RES = [
  /\b(?:can |could )?only (?:help|assist|work|talk|dig|speak|deal|go) (?:with|through|on|into|about)\b/i,
  ...
  /\b(?:that'?s|this is|it'?s) (?:a bit )?(?:outside|beyond)\b[^.?!\n]{0,30}?\b(?:scenario|module|training|what i|scope|help)\b/i,
